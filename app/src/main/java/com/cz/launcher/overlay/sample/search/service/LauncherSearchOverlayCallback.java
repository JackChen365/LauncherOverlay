 ...
 */
public class LauncherSearchOverlayCallback implements Handler.Callback {
    private static final String TAG= LauncherSearchOverlayCallback.class.getSimpleName();
    ...
    public LauncherSearchOverlayCallback(LauncherSearchOverlayComponent overlayComponent) {
